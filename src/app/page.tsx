        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Welcome to <span className="text-green-500">A1Tips</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Your premier destination for professional sports betting tips and predictions. 
              Join thousands of successful bettors who trust A1Tips for winning strategies.
            </p>
